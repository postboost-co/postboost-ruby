...
# Unit tests for PostBoost::ImagePrompt429Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::ImagePrompt429Response do
  let(:instance) { PostBoost::ImagePrompt429Response.new }

  describe 'test an instance of ImagePrompt429Response' do
    it 'should create an instance of ImagePrompt429Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::ImagePrompt429Response)
    end
  end
