...
# Unit tests for PostBoost::BlogToSocial200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::BlogToSocial200Response do
  let(:instance) { PostBoost::BlogToSocial200Response.new }

  describe 'test an instance of BlogToSocial200Response' do
    it 'should create an instance of BlogToSocial200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::BlogToSocial200Response)
    end
  end
