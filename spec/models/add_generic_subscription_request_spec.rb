...
# Unit tests for PostBoost::AddGenericSubscriptionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::AddGenericSubscriptionRequest do
  let(:instance) { PostBoost::AddGenericSubscriptionRequest.new }

  describe 'test an instance of AddGenericSubscriptionRequest' do
    it 'should create an instance of AddGenericSubscriptionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::AddGenericSubscriptionRequest)
    end
  end
  ...
  describe 'test attribute "trial_days"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "keep_prev_trial_ends_at"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
