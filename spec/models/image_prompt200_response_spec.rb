...
# Unit tests for PostBoost::ImagePrompt200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::ImagePrompt200Response do
  let(:instance) { PostBoost::ImagePrompt200Response.new }

  describe 'test an instance of ImagePrompt200Response' do
    it 'should create an instance of ImagePrompt200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::ImagePrompt200Response)
    end
  end
