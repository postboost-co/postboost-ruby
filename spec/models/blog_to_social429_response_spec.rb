...
# Unit tests for PostBoost::BlogToSocial429Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::BlogToSocial429Response do
  let(:instance) { PostBoost::BlogToSocial429Response.new }

  describe 'test an instance of BlogToSocial429Response' do
    it 'should create an instance of BlogToSocial429Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::BlogToSocial429Response)
    end
  end
