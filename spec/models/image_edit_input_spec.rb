...
# Unit tests for PostBoost::ImageEditInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::ImageEditInput do
  let(:instance) { PostBoost::ImageEditInput.new }

  describe 'test an instance of ImageEditInput' do
    it 'should create an instance of ImageEditInput' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::ImageEditInput)
    end
  end

  describe 'test attribute "media_uuid"' do
    it 'should work' do
  ...
  describe 'test attribute "mask_uuid"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
