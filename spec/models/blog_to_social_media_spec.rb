...
# Unit tests for PostBoost::BlogToSocialMedia
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::BlogToSocialMedia do
  let(:instance) { PostBoost::BlogToSocialMedia.new }

  describe 'test an instance of BlogToSocialMedia' do
    it 'should create an instance of BlogToSocialMedia' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::BlogToSocialMedia)
    end
  end
