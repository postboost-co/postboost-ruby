...
# Unit tests for PostBoost::ImageGenerationResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::ImageGenerationResponse do
  let(:instance) { PostBoost::ImageGenerationResponse.new }
  ...
  describe 'test an instance of ImageGenerationResponse' do
    it 'should create an instance of ImageGenerationResponse' do
      ...
      #expect(instance).to be_instance_of(PostBoost::ImageGenerationResponse)
    end
  end
  ...
  describe 'test attribute "prompt_used"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
