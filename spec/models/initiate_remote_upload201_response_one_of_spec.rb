...
# Unit tests for PostBoost::InitiateRemoteUpload201ResponseOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::InitiateRemoteUpload201ResponseOneOf do
  let(:instance) { PostBoost::InitiateRemoteUpload201ResponseOneOf.new }

  describe 'test an instance of InitiateRemoteUpload201ResponseOneOf' do
    it 'should create an instance of InitiateRemoteUpload201ResponseOneOf' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::InitiateRemoteUpload201ResponseOneOf)
    end
  end
