...
# Unit tests for PostBoost::ImageAltTextResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::ImageAltTextResponse do
  let(:instance) { PostBoost::ImageAltTextResponse.new }

  describe 'test an instance of ImageAltTextResponse' do
    it 'should create an instance of ImageAltTextResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::ImageAltTextResponse)
    end
  end
