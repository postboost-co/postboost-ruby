...
# Unit tests for PostBoost::UploadChunk201Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::UploadChunk201Response do
  let(:instance) { PostBoost::UploadChunk201Response.new }

  describe 'test an instance of UploadChunk201Response' do
    it 'should create an instance of UploadChunk201Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::UploadChunk201Response)
    end
  end
