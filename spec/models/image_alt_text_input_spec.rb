...
# Unit tests for PostBoost::ImageAltTextInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::ImageAltTextInput do
  let(:instance) { PostBoost::ImageAltTextInput.new }

  describe 'test an instance of ImageAltTextInput' do
    it 'should create an instance of ImageAltTextInput' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::ImageAltTextInput)
    end
  end
