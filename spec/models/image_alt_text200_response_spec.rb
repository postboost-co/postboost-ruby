...
# Unit tests for PostBoost::ImageAltText200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::ImageAltText200Response do
  let(:instance) { PostBoost::ImageAltText200Response.new }

  describe 'test an instance of ImageAltText200Response' do
    it 'should create an instance of ImageAltText200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::ImageAltText200Response)
    end
  end
