...
# Unit tests for PostBoost::InitiateChunkedUpload201Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::InitiateChunkedUpload201Response do
  let(:instance) { PostBoost::InitiateChunkedUpload201Response.new }

  describe 'test an instance of InitiateChunkedUpload201Response' do
    it 'should create an instance of InitiateChunkedUpload201Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::InitiateChunkedUpload201Response)
    end
  end
