...
# Unit tests for PostBoost::ImageGenerate429Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::ImageGenerate429Response do
  let(:instance) { PostBoost::ImageGenerate429Response.new }

  describe 'test an instance of ImageGenerate429Response' do
    it 'should create an instance of ImageGenerate429Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::ImageGenerate429Response)
    end
  end
