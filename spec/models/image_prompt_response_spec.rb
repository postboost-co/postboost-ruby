...
# Unit tests for PostBoost::ImagePromptResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::ImagePromptResponse do
  let(:instance) { PostBoost::ImagePromptResponse.new }

  describe 'test an instance of ImagePromptResponse' do
    it 'should create an instance of ImagePromptResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::ImagePromptResponse)
    end
  end
