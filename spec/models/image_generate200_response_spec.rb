...
# Unit tests for PostBoost::ImageGenerate200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::ImageGenerate200Response do
  let(:instance) { PostBoost::ImageGenerate200Response.new }

  describe 'test an instance of ImageGenerate200Response' do
    it 'should create an instance of ImageGenerate200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::ImageGenerate200Response)
    end
  end
