...
# Unit tests for PostBoost::ImageVariationsInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::ImageVariationsInput do
  let(:instance) { PostBoost::ImageVariationsInput.new }

  describe 'test an instance of ImageVariationsInput' do
    it 'should create an instance of ImageVariationsInput' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::ImageVariationsInput)
    end
  end
