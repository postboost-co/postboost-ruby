...
# Unit tests for PostBoost::ChangeSubscriptionPlanRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::ChangeSubscriptionPlanRequest do
  let(:instance) { PostBoost::ChangeSubscriptionPlanRequest.new }

  describe 'test an instance of ChangeSubscriptionPlanRequest' do
    it 'should create an instance of ChangeSubscriptionPlanRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::ChangeSubscriptionPlanRequest)
    end
  end
  ...
  describe 'test attribute "billing_immediately"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
