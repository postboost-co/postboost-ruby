...
# Unit tests for PostBoost::ImageVariations200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::ImageVariations200Response do
  let(:instance) { PostBoost::ImageVariations200Response.new }

  describe 'test an instance of ImageVariations200Response' do
    it 'should create an instance of ImageVariations200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::ImageVariations200Response)
    end
  end
