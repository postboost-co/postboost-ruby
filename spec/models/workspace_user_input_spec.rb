...
# Unit tests for PostBoost::WorkspaceUserInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::WorkspaceUserInput do
  let(:instance) { PostBoost::WorkspaceUserInput.new }

  describe 'test an instance of WorkspaceUserInput' do
    it 'should create an instance of WorkspaceUserInput' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::WorkspaceUserInput)
    end
  end
