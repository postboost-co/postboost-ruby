...
# Unit tests for PostBoost::GeneratedImageItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PostBoost::GeneratedImageItem do
  let(:instance) { PostBoost::GeneratedImageItem.new }

  describe 'test an instance of GeneratedImageItem' do
    it 'should create an instance of GeneratedImageItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PostBoost::GeneratedImageItem)
    end
  end
