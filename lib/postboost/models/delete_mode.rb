...
module PostBoost
  class DeleteMode
    APP_ONLY = "app_only".freeze
    APP_AND_SOCIAL = "app_and_social".freeze
    SOCIAL_ONLY = "social_only".freeze

    def self.all_vars
      @all_vars ||= [APP_ONLY, APP_AND_SOCIAL, SOCIAL_ONLY].freeze
    end
    ...
    def build_from_hash(value)
      return value if DeleteMode.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #DeleteMode"
    end
  end
end
