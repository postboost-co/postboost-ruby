...
module PostBoost
  class ChangeSubscriptionPlanRequest
    ...
    attr_accessor :billing_immediately
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PostBoost::ChangeSubscriptionPlanRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PostBoost::ChangeSubscriptionPlanRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'billing_immediately')
        self.billing_immediately = attributes[:'billing_immediately']
      else
        self.billing_immediately = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @prorate.nil?
        invalid_properties.push('invalid value for "prorate", prorate cannot be nil.')
      end

      if @billing_immediately.nil?
        invalid_properties.push('invalid value for "billing_immediately", billing_immediately cannot be nil.')
      end
    ...
    def valid?
      ...
      cycle_validator = EnumAttributeValidator.new('String', ["monthly", "yearly"])
      return false unless cycle_validator.valid?(@cycle)
      return false if @prorate.nil?
      return false if @billing_immediately.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cycle == o.cycle &&
          prorate == o.prorate &&
          billing_immediately == o.billing_immediately
    end
    ...
    def hash
      [plan_id, cycle, prorate, billing_immediately].hash
    end
