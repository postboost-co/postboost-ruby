  ...
  class BlogToSocialCaption
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PostBoost::BlogToSocialCaption` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PostBoost::BlogToSocialCaption`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'character_limit')
        self.character_limit = attributes[:'character_limit']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          character_limit == o.character_limit &&
          error == o.error
    end
    ...
    def hash
      [account_id, provider, content, character_count, character_limit, error].hash
    end
