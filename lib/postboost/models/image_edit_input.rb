  ...
  class ImageEditInput
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PostBoost::ImageEditInput` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PostBoost::ImageEditInput`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'media_uuid')
        self.media_uuid = attributes[:'media_uuid']
      else
        self.media_uuid = nil
      end
      ...
      if attributes.key?(:'mask_uuid')
        self.mask_uuid = attributes[:'mask_uuid']
      end
    ...
    def list_invalid_properties
      ...
      if @media_uuid.nil?
        invalid_properties.push('invalid value for "media_uuid", media_uuid cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @media_uuid.nil?
      return false if @prompt.nil?
      return false if @prompt.to_s.length > 4000
    ...
    def ==(o)
      ...
      self.class == o.class &&
          media_uuid == o.media_uuid &&
          prompt == o.prompt &&
          mask_uuid == o.mask_uuid &&
    ...
    def hash
      [media_uuid, prompt, mask_uuid, aspect_ratio, count, quality].hash
    end
