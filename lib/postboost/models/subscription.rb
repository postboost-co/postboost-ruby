...
module PostBoost
  class Subscription
    ...
    attr_accessor :platform_subscription_id

    attr_accessor :platform_plan_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PostBoost::Subscription` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PostBoost::Subscription`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'paused_from')
        self.paused_from = attributes[:'paused_from']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          name == o.name &&
          platform_subscription_id == o.platform_subscription_id &&
          platform_plan_id == o.platform_plan_id &&
          status == o.status &&
          recurring == o.recurring &&
          trial_ends_at == o.trial_ends_at &&
          paused_from == o.paused_from &&
          ends_at == o.ends_at
    end
    ...
    def hash
      [name, platform_subscription_id, platform_plan_id, status, recurring, trial_ends_at, paused_from, ends_at].hash
    end
